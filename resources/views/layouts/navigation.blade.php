            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img src="{{ asset('image/usm.webp') }}" class="block h-9 w-auto fill-current text-gray-800 dark:text-gray-200" alt="Logo USM">
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="url('matkul')" :active="request()->routeIs('matkul')">
                        {{ __('Mata Kuliah') }}
                    </x-nav-link>
                </div>
            </div>
